...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-fa4k^yo^7mkl_0(lkg5!=#5iz753aab%ac&v35&azx#_cm&0_%')
...
#         'NAME': config('DB_NAME', default='classified_ads'),
...
# Email settings (for Phase 1 email verification)
