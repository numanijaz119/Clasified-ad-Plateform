      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Track revenue from featured ad promotions</p>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-sm border border-green-200 p-6">
          ...
          <p className="text-3xl font-bold text-green-900">{totalFeaturedAds.toLocaleString()}</p>
          <p className="text-sm text-green-700 mt-1">Featured Ads</p>
          <p className="text-xs text-green-700 mt-2">${FEATURED_AD_PRICE} per ad</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-sm border border-blue-200 p-6">
          ...
          <p className="text-3xl font-bold text-blue-900">${estimatedRevenue}</p>
          <p className="text-sm text-blue-700 mt-1">Total Revenue</p>
          <p className="text-xs text-blue-700 mt-2">From {totalFeaturedAds} featured ads</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-sm border border-purple-200 p-6">
          ...
          <p className="text-xs text-purple-700 mt-2">{newFeaturedThisWeek} new featured ads</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow-sm border border-orange-200 p-6">
          ...
          <p className="text-3xl font-bold text-orange-900">${FEATURED_AD_PRICE}</p>
          <p className="text-sm text-orange-700 mt-1">Price per Ad</p>
          <p className="text-xs text-orange-700 mt-2">Standard featured pricing</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-6">
          {/* By Status */}
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-3">Featured Ads by Status</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-2">{stats.ads.featured}</p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-2">{stats.ads.total}</p>
                <p className="text-sm text-gray-600 mt-1">
                  {((stats.ads.featured / stats.ads.total) * 100).toFixed(1)}% are featured
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-600 mt-1">
                  ${((stats.ads.active - stats.ads.featured) * FEATURED_AD_PRICE).toFixed(2)}{" "}
                  potential
                </p>
              </div>
            </div>
          ...
          {/* Revenue Projection */}
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-3">Revenue Projections</h4>
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-sm text-gray-600 mb-2">If 25% of active ads promote:</p>
                  <p className="text-3xl font-bold text-green-600">
                    ${(Math.floor(stats.ads.active * 0.25) * FEATURED_AD_PRICE).toFixed(2)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-2">If 50% of active ads promote:</p>
                  <p className="text-3xl font-bold text-blue-600">
                    ${(Math.floor(stats.ads.active * 0.5) * FEATURED_AD_PRICE).toFixed(2)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                ...
                <h5 className="text-sm font-semibold text-gray-900 mb-1">Premium Placement</h5>
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <h5 className="text-sm font-semibold text-gray-900 mb-1">Increased Visibility</h5>
                <p className="text-xs text-gray-600">
              ...
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                ...
                <h5 className="text-sm font-semibold text-gray-900 mb-1">Faster Results</h5>
                <p className="text-xs text-gray-600">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-2xl font-bold text-gray-900">{stats.ads.featured}</p>
            <p className="text-sm text-gray-600 mt-1">Featured Ads</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-2xl font-bold text-gray-900">${estimatedRevenue}</p>
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-2xl font-bold text-gray-900">${FEATURED_AD_PRICE}</p>
