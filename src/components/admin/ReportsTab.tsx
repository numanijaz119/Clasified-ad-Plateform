      ...
      case "fraud":
        return (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
            <p className="text-sm font-semibold text-red-900 mb-2">⚠️ Action Outcome:</p>
            <p className="text-sm text-red-800 mb-2">
              The reported ad will be <strong>REJECTED</strong> and removed from listings.
            </p>
            <p className="text-xs text-red-700">The reporter will be notified of your decision.</p>
          </div>
        );
      case "inappropriate":
        return (
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
            <p className="text-sm font-semibold text-orange-900 mb-2">⚠️ Action Outcome:</p>
      ...
      default:
        return (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-sm font-semibold text-blue-900 mb-2">ℹ️ Action Outcome:</p>
            <p className="text-sm text-blue-800 mb-2">
              The ad status will remain unchanged. You can add notes for the reporter.
            </p>
            <p className="text-xs text-blue-700">The reporter will be notified of your decision.</p>
          </div>
        );
    }
  };
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-shrink-0">
                      {report.ad.image ? (
                        <img
                          src={
                            report.ad.image.startsWith("http")
                              ? report.ad.image
                              : `${API_CONFIG.BASE_URL}${report.ad.image}`
                          }
                          alt={report.ad.title}
                      ...
                      <div
                        className={`w-20 h-20 bg-gray-200 rounded-lg flex items-center justify-center ${report.ad.image ? "hidden" : ""}`}
                      >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mb-2 flex-wrap">
                            ...
                            >
                              Ad:{" "}
                              {report.ad.status.charAt(0).toUpperCase() + report.ad.status.slice(1)}
                            </Badge>
                          ...
                          {isProcessed && actionOutcome && (
                            <div className="bg-green-50 border border-green-200 rounded p-1.5 mb-1">
                              <p className="text-xs font-medium text-green-900">{actionOutcome}</p>
                            </div>
                          )}
      ...
      {showActionModal && selectedReport && (
        <div className="fixed inset-0 !mt-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-lg w-full p-6">
            ...
            {actionType === "dismiss" && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <p className="text-sm font-semibold text-blue-900 mb-2">ℹ️ Dismiss Report:</p>
                <p className="text-sm text-blue-800">
                  The ad will remain unchanged. You can add notes to explain your decision to the
                  reporter.
                </p>
              </div>
            )}
            ...
            <div className="flex gap-3">
              ...
              <button onClick={submitAction} disabled={isSubmitting} className="flex-1 btn-primary">
                {isSubmitting ? (
                  <>
