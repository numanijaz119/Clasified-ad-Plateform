...
import { MessageCircle, Unlock, ExternalLink, ArrowLeft, ChevronRight, MoreVertical, Ban } from 'lucide-react';
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-full bg-gray-200 flex-shrink-0 overflow-hidden">
                            {userInfo.avatar ? (
                                <img src={userInfo.avatar} alt={userInfo.full_name} className="w-full h-full object-cover" />
                            ) : (
                        ...
                        return (
                            <div key={conversation.id} className="relative group">
                                <button
                                    ...
                                    `}
                                >
                                    <img src={adImage} alt={conversation.ad.title} className="w-16 h-16 object-cover rounded flex-shrink-0" />
                                    
                                    <div className="flex-1 min-w-0">
                                        <h4 className="font-medium text-gray-900 truncate mb-1">{conversation.ad.title}</h4>
                                        <p className="text-sm font-semibold text-orange-600 mb-1">{conversation.ad.display_price}</p>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mb-1">
                                            <p className="text-sm text-gray-600 truncate flex-1">{conversation.ad.title}</p>
                                            {onAdClick && (
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                    ...
                                    {hasUnread && (
                                        <span className="badge badge-error flex-shrink-0">{conversation.unread_count}</span>
                                    )}
                                </div>
                            </button>
                            ...
                            <div className="flex items-start justify-between mb-2 mr-6">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-500">{userConversations.length} conversation{userConversations.length > 1 ? 's' : ''}</p>
                                    </div>
                                </div>
