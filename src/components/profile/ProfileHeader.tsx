...
const ProfilePage: React.FC = () => {
  // Use AuthContext to get user and updateUser function
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update all state with fresh user data
      setUser(updatedUser);
      updateUser(updatedUser); // Update AuthContext

      // Update form data with the response to reflect any server-side changes
      setFormData({
      ...
      // Update avatar preview if there's a new avatar URL from server
      if (updatedUser.avatar && updatedUser.avatar !== avatarPreview) {
