...
const AdminDashboard: React.FC = () => {
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                $
                {bannerAds
                  .reduce((sum, banner) => sum + banner.price, 0)
                  .toLocaleString()}
              </p>
            </div>
          </div>
  ...
  const totalFeaturedAds = earningsData.reduce(
    (sum, data) => sum + data.featuredAds,
    0
  );
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                ${earningsData[0]?.revenue.toLocaleString()}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          <div className="border-b border-gray-200">
            <nav className="flex gap-x-4 flex-wrap px-6" aria-label="Tabs">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
