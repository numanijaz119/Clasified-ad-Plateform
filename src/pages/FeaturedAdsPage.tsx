...
const FeaturedAdsPage: React.FC = () => {
  ...
  const featuredListings: Listing[] = [
    ...
    },
    {
      ...
      timeAgo: '1 day ago',
      featured: true,
      description: 'Stunning 4-bedroom home with pool and modern amenities in prime location.',
      postedDate: new Date('2025-01-11'),
      phone: '(217) 555-0108',
    ...
    },
    {
      ...
      timeAgo: '2 days ago',
      featured: true,
      description: 'BMW X5 with premium package, low mileage, excellent condition.',
      postedDate: new Date('2025-01-10'),
      phone: '(815) 555-0109',
    ...
    },
    {
      ...
      timeAgo: '2 days ago',
      featured: true,
      description: 'Certified Ayurvedic practitioner offering personalized wellness consultations.',
      postedDate: new Date('2025-01-10'),
      phone: '(217) 555-0110',
    ...
    },
    {
      ...
      timeAgo: '3 days ago',
      featured: true,
      description: 'Lead marketing campaigns for diverse client portfolio. Experience in digital marketing required.',
    ...
    },
    {
      ...
      timeAgo: '3 days ago',
      featured: true,
      description: 'iPhone 14 Pro Max in excellent condition, unlocked for all carriers.',
      postedDate: new Date('2025-01-09'),
      phone: '(312) 555-0112',
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600">
                {filteredListings.length} featured listings • Premium ads from our community
              </p>
            ...
            {filteredListings.length === 0 && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">No featured ads found</h3>
